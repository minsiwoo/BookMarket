...
<div class="container">
    <form:form modelAttribute="order" class="form-horizontal">
        ...
        <div class="row">
            ...
            <div calss="col-md-6 text-right">
                <p><em>q=배송일: <fmt:formatDate type="date" value="${order.shipping.date}"/></em></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-9">
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="cartItem" items="${order.cart.cartItems}">
                    <tr>
                        ...
                        <td class="text-center">${cartItem.value.book.totalPrice}원</td>
                    </tr>
                </c:forEach>
                <tr>
                    <td> </td>
